                  ...
                  <div className="Main-full-notice-root">
                    <div className="High-notices-root">
                        <Toolbar>
                            ...
                            <Typography variant="h3" textAlign="center">Реферальная система</Typography>
                        </Toolbar>
                        <div className="Middle-notices-root">
                            <ul className="menu-notices-ul">
                                <li>
                                  <Link style={{ textDecoration: 'none', color: 'inherit' }} to="/pricing-menu/referral/referral-settings">
                                    <Button size="large" color="inherit">Изменения %</Button>
                                  </Link>
                                  </li>
                                <li>
