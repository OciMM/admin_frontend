...
export default class ReservationArchive extends Component {
    constructor(props) {
        super(props);
        this.state = {
          yourData: [
                    ...
                    <div className="Reservation-root">
                        <div className="High-root">
                            <Toolbar>
                                ...
                                <Typography variant="h3" textAlign="center">Архив броней</Typography>
                            </Toolbar>
                        </div>
                        ...
                        <div className="Low-root">
                          <Grid mt={7} mb={7} container direction="row" spacing={1}>
