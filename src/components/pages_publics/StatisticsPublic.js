import { Container, Grid, Input, Toolbar, Typography } from '@mui/material'
...
export default class StatisticsPublic extends Component {
    constructor(props) {
        super(props)
                                    ...
                                    <Grid item lg={6}>
                                        <div className="Main-Info">
                                            ...
                                            <Grid container mb={2} justifyContent="center">
                                                <Grid item>
                                                    <Typography>Сроки <Input type="date"/> по <Input type="date" /> </Typography>
                                                </Grid>
                                            </Grid>
                                        </div>
                                        {divElements}
