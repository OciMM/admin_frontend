...
export default class FilterPublics extends Component {
    constructor(props) {
        super(props)
                ...
                <Grid item lg={12} md={12} xs={12}>
                  <div className="Main-full-root">
                    <div className="High-root">
                      <Toolbar>
                        <Link to="http://localhost:3000/publics"><ArrowBackIcon color="warning" fontSize="large" /></Link>
                        <Typography variant="h3" textAlign="center">Фильтр сообществ</Typography>
                      </Toolbar>
                    </div>
                    <div className="Middle-root">
                        ...
                        <div className="data-root">
                            <h5>Количество подписчиков в сообществе</h5>
                            <Grid container justifyContent="center">
                                <Grid item className='filters-data'>
                                    <Button size="large" color="inherit">По большинству</Button>
                                </Grid>
