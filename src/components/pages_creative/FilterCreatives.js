...
export default class FilterCreatives extends Component {
    constructor(props) {
        super(props)
                  ...
                  <div className="Main-full-root">
                    <div className="High-root">
                      <Toolbar>
                        ...
                        <Typography variant="h3" textAlign="center">Фильтр креативов</Typography>
                      </Toolbar>
                    </div>
                    <div className="Middle-root">
                        ...
                        <div className="data-root">
                            <Grid container justifyContent="center">
                                <Grid item className='filters-data'>
                                    <Button size="large" color="inherit">По самому высокому CTR</Button>
                                </Grid>
                                <Grid item className='filters-data'>
                                    <Button size="large" color="inherit">По самому низкому CTR</Button>
                                </Grid>
                            </Grid>
                        </div>
                        <div className="data-root">
